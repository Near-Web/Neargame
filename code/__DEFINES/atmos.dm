...
#define MINIMUM_AIR_RATIO_TO_SUSPEND 0.0000000000 //Previus: 0.05. If there is a lag significantly increased by several orders of magnitude. Minimum ratio of air that must move to/from a tile to suspend group processing
