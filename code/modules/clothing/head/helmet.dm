...
/obj/item/clothing/head/helmet/lw/ironopenhelmet
	...
	desc = "Will protect your head, but exchanges face protection for visibility!"
	icon_state = "newopen"
	item_state = "helmet"
...
/obj/item/clothing/head/helmet/sechelm
	name = "Triton helmet"
	desc = "The iconic helmet worn by members of the Triton Guard."
	icon_state = "triton"
...
/obj/item/clothing/head/helmet/sechelm/trusted
	icon_state = "triton"
	armor = list(melee = 45, bullet = 0, laser = 0, energy = 15, bomb = 15, bio = 0, rad = 0)
	desc = "The iconic helmet worn by members of the Triton Guard. This one looks tougher."

/obj/item/clothing/head/helmet/sechelm/veteran
	name = "Kraken's helmet"
	desc = "Unique helmet of the Baron's deathbringer."
	shockable = FALSE
	icon_state = "kraken"
...
/obj/item/clothing/head/helmet/reddawn
	name = "Red-Dawn helmet"
	desc = "The full steel facemask Red-Dawn mercs use."
	icon_state = "reddawn"
	flags_inv = HIDEEARS|HIDEEYES|HIDEFACE|BLOCKHAIR
	item_state = "reddawn"
	flags = FPRINT|TABLEPASS|HEADCOVERSEYES|HEADCOVERSMOUTH|BLOCKHAIR
	body_parts_covered = HEAD|FACE|MOUTH
	armor = list(melee = 50, bullet = 20, laser = 0, energy = 10, bomb = 10, bio = 0, rad = 0)
	item_worth = 24
	cold_protection = HEAD
	min_cold_protection_temperature = HELMET_MIN_COLD_PROTECTION_TEMPERATURE
	heat_protection = HEAD
...
/obj/item/clothing/head/helmet/sechelm/incarn
	name = "incarn hood"
	desc = "The strange gothic hood worn by The Incarn. A symbol of his faith."
	icon_state = "keeper"
	item_state = "tdred"
	shockable = FALSE
	armor_type = ARMOR_LEATHER
...
/obj/item/clothing/head/helmet/sechelm/chariot
	name = "minotaur helm"
	desc = "The strange horned helmet worn by The Chariot. A symbol of his faith."
	icon_state = "chariot"
	item_state = "tdred"
	shockable = FALSE
	armor_type = ARMOR_METAL
...
/obj/item/clothing/head/helmet/sechelm/cerbhelm
	...
	desc = "The loyal hounds of a long dead Baron, long put to rest during their sacrifice at the Gate. Honor and Tyranny."
	icon_state = "cerbhelm"
	shockable = FALSE
	item_state = "cerbh"
	armor_type = ARMOR_METAL
